...
public interface IHopper {
	static void markDirtyLikeHopperWould(IInventory inv, InventoryOptimizer opt, InventoryOptimizer masterOpt) {
	 ...
	 */
	boolean tryShortcutFailedExtract(InventoryOptimizer thisOpt, IInventory other, InventoryOptimizer otherOpt);
	 ...
	 * @return Whether the current item transfer attempt is known to fail.
	 */
	boolean tryShortcutFailedInsert(InventoryOptimizer thisOpt, IInventory other, InventoryOptimizer otherOpt);
